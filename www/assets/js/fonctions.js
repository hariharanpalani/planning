	...
	end : function(e)
	{
		...
		if(origineCaseX != parseInt(Drag.obj.style.left) || origineCaseY != parseInt(Drag.obj.style.top)) {
			...
			if (destination == null) {
				...
				document.getElementById('divChoixDragNDrop').style.position = 'absolute';
				document.getElementById('divChoixDragNDrop').style.top = jQuery("#" + Drag.obj.id).offset().top + 15 + "px";
				document.getElementById('divChoixDragNDrop').style.left = jQuery("#" + Drag.obj.id).offset().left + "px";
...
function initselect2(lang,choix) {
