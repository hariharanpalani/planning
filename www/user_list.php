...
$sql = 'SELECT distinct pu.nom, pu.email, pu.user_id, pu.login, pu.visible_planning, pu.couleur, pu.droits, pug.nom AS nom_groupe, pu.adresse, pu.telephone, pu.mobile, pu.metier, pu.commentaire, pu.date_dernier_login, COUNT(pp.periode_id) AS totalPeriodes,
					pr.nom as resource_name
					...
					LEFT JOIN planning_ressource pr on pr.ressource_id = pu.resource_id
