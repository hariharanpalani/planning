...
<form class="form-horizontal" method="get" action="export_pdf.php" target="_blank">
	<div class="form-group">
		<label class="col-md-4 control-label">{#PDFExport_orientation#} :</label>
		<div class="col-md-6">
	...
	<div class="form-group">
		<label class="col-md-4 control-label">{#PDFExport_format#} :</label>
		<div class="col-md-6">
	...
	<div class="form-group">
		...
		<div class="col-md-6">
			<br>
			<input type="submit" class="btn btn-primary" value="{#winPeriode_valider#|escape:"html"}" />
		</div>
	</div>
</form>