	...
	<div class="row">
		<div class="col-md-12">
			<div class="soplanning-box">
				<div class="btn-group">
					<a href="{$BASE}/user_list.php" class="btn btn-sm btn-default" ><i class="fa fa-address-card-o fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuGestionUsers#}</a>
					<a href="javascript:xajax_modifUserGroupe();undefined;" class="btn btn-sm btn-default"><i class="fa fa-users fa-lg fa-fw" aria-hidden="true"></i>&nbsp;&nbsp;{#menuCreerUserGroupe#}</a>
				</div>
			</div>
		</div>
	</div>
				...
				{if $groupes|@count > 0}
					<table class="table table-striped table-hover">
						...
						{foreach name=groupes item=groupe from=$groupes}
							<tr>
								<td class="w40">
									<a href="javascript:xajax_modifUserGroupe({$groupe.user_groupe_id});undefined;"><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></a>
									<a href="javascript:if(confirm('{#confirm#|escape:"javascript"}')){literal}{{/literal}javascript:xajax_supprimerUserGroupe({$groupe.user_groupe_id});{literal}}{/literal};undefined;"><i class="fa fa-trash-o fa-fw" aria-hidden="true"></i></a>
								</td>
