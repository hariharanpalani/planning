...
<div class="container">
	<form action="stats_users.php" method="POST" class="form-inline" id="formGraphe">
	...
	<div class="soplanning-box margin-top-10">
		<div class="titrePage" align="center">{#droits_stats_users#}</div>
		<br>
		<div class="row">
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-4">
					<input type="radio" name="abscisse_echelle" id="abscisse_echelle_jour" value="jour" style="margin-bottom:6px" {if $stats_users.abscisse_echelle eq "jour"}checked="checked"{/if}>
					<label for="abscisse_echelle_jour">{#stats_abscisse_echelle_jour#}</label>
					&nbsp;&nbsp;&nbsp;
					<input type="radio" name="abscisse_echelle" id="abscisse_echelle_semaine" value="semaine" style="margin-bottom:6px" {if $stats_users.abscisse_echelle eq "semaine"}checked="checked"{/if}>
					<label for="abscisse_echelle_semaine">{#stats_abscisse_echelle_semaine#}</label>
					&nbsp;&nbsp;&nbsp;
					<input type="radio" name="abscisse_echelle" id="abscisse_echelle_mois" value="mois" style="margin-bottom:6px" {if $stats_users.abscisse_echelle eq "mois"}checked="checked"{/if}>
				...
				<div class="col-md-4">
					<input type="radio" name="abscisse_echelle_valeur" id="abscisse_echelle_valeur_heures" value="heures" style="margin-bottom:6px" {if $stats_users.abscisse_echelle_valeur eq "heures"}checked="checked"{/if}>
					<label for="abscisse_echelle_valeur_heures">{#stats_abscisse_valeur_heures#}</label>
					&nbsp;&nbsp;&nbsp;
					<input type="radio" name="abscisse_echelle_valeur" id="abscisse_echelle_valeur_jours" value="jours" style="margin-bottom:6px" {if $stats_users.abscisse_echelle_valeur eq "jours"}checked="checked"{/if}>
		...
		<div class="row">
			<div class="form-group col-md-12">
				...
				<div class="col-md-4">
					<input type="radio" name="grille" id="grille_h" value="grille_h" style="margin-bottom:6px" {if $stats_users.grille eq "grille_h"}checked="checked"{/if}>
					<label for="grille_h">{#stats_graphe_grille_h#}</label>
					&nbsp;&nbsp;&nbsp;
					<input type="radio" name="grille" id="grille_v" value="grille_v" style="margin-bottom:6px" {if $stats_users.grille eq "grille_v"}checked="checked"{/if}>
					<label for="grille_v">{#stats_graphe_grille_v#}</label>
					&nbsp;&nbsp;&nbsp;
					<input type="radio" name="grille" id="grille_hv" value="grille_hv" style="margin-bottom:6px" {if $stats_users.grille eq "grille_hv"}checked="checked"{/if}>
	...
	<div class="soplanning-box margin-top-10">
		<div class="row">
			<div class="col-md-12">
				...
				<img id="imgGraphe" src="graphe_users.php" onload="jQuery('#imgLoading').hide();jQuery('#imgGraphe').show();" style="display:none;" />
			</div>
		</div>
	</div>
